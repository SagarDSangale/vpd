						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="at-innerbannercontent">
								<ol class="at-breadcrumb">
									...
									<li class="at-active"><span>Services To Non Profit Organizations</span></li>
								</ol>
							</div>
						</div>
					</div>
								...
								<aside class="at-sidebar">
									<div class="at-widget at-widgetlinking">
										<div class="at-widgetcontent">
												...
												<li class="at-active"><a href="services-to-non-profit-organizations">Services To Non Profit Organizations</a></li>
											</ul>
										</div>
									</div>
							...
							<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 pull-left">
								...
								<section class="at-servicedetailsection">
									<div class="at-sectiontitleborder">
										<h2>SERVICES TO NON-PROFIT ORGANIZATIONS</h2>
									</div>
									<div class="at-description">
										...
										<p>VPD & Associates also provides various servicespertaining to the requirements of Foreign Contribution Regulation Act involving preparation of project and feasibility reports, undertaking FCRA Registration, Registration under the Income Tax Act for tax exemptions etc.</p>
