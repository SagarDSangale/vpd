    ...
    <!--************************************
		...
		*************************************-->
		<div class="at-homesliderarea">
			...
			<a class="at-infoemail" href="mailto:office@vpdassocites.com">office@vpdassocites.com</a>
		</div>
		<!--************************************
				Home Slider End
		*************************************-->
							...
							<div class="item">
								...
								<ul class="at-contactinfo">
									...
									<li>
										...
										<address>Flat No. 401, Dhanwantari Terrace, Opposite Kalmadi Pre-Primary School,Behind Karnataka College, Erandwane, Pune – 411038</address>
									</li>
								</ul>
							</div>
							<!-- <div class="item">
