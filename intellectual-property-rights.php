				...
				<div class="row">
				 <?php include 'logo.php'; ?>  
					<div class="at-navigationarea">
                      ...
                      <li class="current-menu-item"><a href="intellectual-property-rights">Intellectual Property</a></li>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="at-innerbannercontent">
								<ol class="at-breadcrumb">
									...
									<li class="at-active"><span>Intellectual Property Rights</span></li>
								</ol>
							</div>
						</div>
					</div>
						...
						<div class="at-services at-servicedetail">
									...
									<div class="at-widget at-widgetlinking">
										<div class="at-widgetcontent">
											<ul>
												...
												<li class="at-active"><a href="intellectual-property-rights">Intellectual Property Rights</a></li>
							...
							<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 pull-left">
								...
								<section class="at-servicedetailsection">
									...
									<div class="at-description">
										<p>Intellectual Property is a product of intellect that has commercial value. The privileges given to the owners of such property are called the Intellectual Property Rights (IPR). The importance of intellectual property in India is well established at all levels- Statutory, Administrative and Judicial. It is essential to ascertain and maintain IPR.</p>
									
										<h4>Our Services in this area include:</h4> 
									<ul class="at-liststyle at-liststylearrowright">
														<li>Ascertaining the rights – Copyrights and Trade Marks.</li>
														<li>Registering the Copyrights and Trade Marks with the concerned authorities</li>
														<li>Maintaining and renewal of the Rights</li>
