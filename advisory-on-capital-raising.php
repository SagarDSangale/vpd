							...
							<div id="at-navigation" class="collapse navbar-collapse at-navigation">
								<ul>
									...
									<li class="menu-item-has-children current-menu-item">
										...
										<ul class="sub-menu">
                      <li class="current-menu-item"><a href="company-and-llp-formation">Company and LLP Formation</a></li>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="at-innerbannercontent">
								<ol class="at-breadcrumb">
									...
									<li class="at-active"><span>Advisory On Capital Raising</span></li>
								</ol>
							</div>
						</div>
					</div>
					...
					<div class="at-content">
						<div class="at-services at-servicedetail">
								...
								<aside class="at-sidebar">
									<div class="at-widget at-widgetlinking">
										<div class="at-widgetcontent">
											<ul>
												<li ><a href="corporate-secretarial-services">Corporate Secretarial Services</a></li>
												<li><a href="regulatory-approvals-and-representation">Regulatory Approvals And Representation</a></li>
												<li><a href="corporate-governance">Corporate Governance</a></li>
												<li><a href="legal-due-diligence-and-transaction-documents">Legal Due Diligence And Transaction Documents</a></li>
												<li><a href="join-ventures-mergers-amalgamations-and-acquisitions">Join Ventures Mergers Amalgamations And Acquisitions</a></li>
												<li ><a href="compliance-under-foreign-exchange-laws">Compliance Under Foreign Exchange Laws</a></li>
												<li ><a href="intellectual-property-rights">Intellectual Property Rights</a></li>
												<li class="at-active"><a href="advisory-on-capital-raising">Advisory On Capital Raising</a></li>
												<li><a href="services-to-non-profit-organizations">Services To Non Profit Organizations</a></li>
											</ul>
										</div>
									</div>
							...
							<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 pull-left">
								<figure class="at-sectionimg"><div class="at-imgholder"><img src="images/services/img-11.jpg" alt="image description"></div></figure>
								<section class="at-servicedetailsection">
									<div class="at-sectiontitleborder">
										<h2>ADVISORY ON CAPITAL RAISING</h2>
									</div>
									<div class="at-description">
										<p>VPD & Associates provides clients with all necessary assistance, as required under the present legal framework, in advising and arranging domestic and international capital requirements, which includes the following:</p>
									
										
									<ul class="at-liststyle at-liststylearrowright">
										<li>Assisting in arriving at the capital structure – proper mix of equity and debt</li>
										<li>Identifying the appropriate capital sources including the following:</li>	
												<ul class="at-liststyle at-liststylearrowright">
												<li>Capital raising from seed to growth</li>
												<li>Equity raising through Initial Public Offer, Private Equity etc.</li>
												<li>Issuing Corporate Bonds</li>										
												<li>Overseas funding in the form of Foreign Currency Convertible Bonds (FCCB), External Commercial Borrowings (ECB), Global Depository Receipts (GDR) etc</li>										
												<li>Assisting in preparation of Business Plan / Information Memorandum</li>										
												<li>Advising on the appropriate time for raising funds and all the relevant strategic and regulatory issues concerned with fund raising</li>										
												<li>Connecting with the various intermediaries such as Merchant Bankers, Credit Rating Agencies, Bankers, Legal Council, Accountants, Listing authorities etc.</li>										
												<li>Listing related compliance</li>										
												<li>Drafting the necessary documents relating to capital raising</li>																			
									</ul>									
									</ul>
									</div>
								</section>
