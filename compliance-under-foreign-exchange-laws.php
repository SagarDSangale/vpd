						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="at-innerbannercontent">
								<ol class="at-breadcrumb">
									...
									<li class="at-active"><span>Compliance Under Foreign Exchange Laws</span></li>
								</ol>
							</div>
						</div>
					</div>
									...
									<div class="at-widget at-widgetlinking">
										<div class="at-widgetcontent">
											<ul>
												...
												<li class="at-active"><a href="compliance-under-foreign-exchange-laws">Compliance Under Foreign Exchange Laws</a></li>
							...
							<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 pull-left">
								...
								<section class="at-servicedetailsection">
									<div class="at-sectiontitleborder">
										<h2>COMPLIANCE UNDER FOREIGN EXCHANGE LAWS</h2>
									</div>
									<div class="at-description">
									
										<p>With the globe shrinking on account of the World Wide Web, cross border transactions have become the order of the present business era.<h4>Our services in this area include:</h4></p>
										
										<ul class="at-liststyle at-liststylearrowright">
											<li>Advising on the Inbound and Outbound investments.</li>
											<li>Setting up of Wholly Owned Subsidiaries, Joint Ventures and Branch Offices in India and overseas.</li>
											<li>Assisting in obtaining the required approvals from the Foreign Investment Promotion Board, Govt. of India</li>
											<li>Foreign Direct Investment Compliances.</li>
											<li>External Commercial Borrowing.</li>
										</ul>
