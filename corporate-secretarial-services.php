						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="at-innerbannercontent">
								<ol class="at-breadcrumb">
									...
									<li class="at-active"><span>Corporate Secretarial Services</span></li>
								</ol>
							</div>
						</div>
					</div>
								...
								<aside class="at-sidebar">
									<div class="at-widget at-widgetlinking">
										<div class="at-widgetcontent">
											<ul>
												<li class="at-active"><a href="corporate-secretarial-services">Corporate Secretarial Services</a></li>
							...
							<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 pull-left">
								...
								<section class="at-servicedetailsection">
									...
									<div class="at-description">
										...
										<p><h4>Business Set-Up services:</h4> Advisory service regarding the most suitable form of organization, based on the clients specific needs and objectives; incorporation of all types of companies under the Companies Act, 2013, Limited Liability Partnerships, Offshore Companies, Wholly Owned Subsidiaries, and Joint Ventures. Obtaining all required approvals and licenses for commencement of the business from local, municipal, state and central government authorities, including (but not limited to) PAN, TAN, &GST Registrations, Municipal Trade license, NOC from Fire Department & Pollution Control Board, Shops & Establishments, STPI, Foreign Trade and Single Window clearances from the Micro, Small and Medium Enterprises Directorate (MSMED).</p>
										<p><h4>Regular Compliance Services:</h4> On-site and off-shore Legal Compliance and Advisory services [on both ongoing and retainer basis] concerning various laws such as Company Law, Foreign Exchange Law, Securities Laws, Labour Laws and other related and applicable laws.</p>
