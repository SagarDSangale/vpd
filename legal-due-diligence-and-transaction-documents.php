						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="at-innerbannercontent">
								<ol class="at-breadcrumb">
									...
									<li class="at-active"><span>Legal Due Diligence And Transaction Documents</span></li>
								</ol>
							</div>
						</div>
					</div>
									...
									<div class="at-widget at-widgetlinking">
										<div class="at-widgetcontent">
											<ul>
												...
												<li ><a href="corporate-governance">Corporate Governance</a></li>
												<li class="at-active"><a href="legal-due-diligence-and-transaction-documents">Legal Due Diligence And Transaction Documents</a></li>
							...
							<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 pull-left">
								...
								<section class="at-servicedetailsection">
									<div class="at-sectiontitleborder">
										<h2>LEGAL DUE DILIGENCE AND TRANSACTION DOCUMENTS</h2>
									</div>
									<div class="at-description">
									
										<p>The corporate strategists and investors are required to do a deep-dive analysis of the corporate history & culture, legal compliance and management competence of the organisation so as to arrive at an informed decision before shaking hands. We at VPD & Associates have gained expertise in Legal Due Diligence in the event of:</p>
										
										<ul class="at-liststyle at-liststylearrowright">
											<li>an Investment by way of Private Equity or Venture Funding.</li>
											<li>an Acquisition of the Company.</li>
											<li>a Merger of two or more companies.</li>
											<li>an Initial Public Offering or Follow on Offer.</li>
										</ul>

										<p>We at VPD & Associates take pride of our skills in drafting and vetting of the various Legal documents, Agreements including (but not limited to):</p>

										<ul class="at-liststyle at-liststylearrowright">
											<li>Scheme of Amalgamation / Merger.</li>
											...
											<li>Stock Swap Agreements.</li>
											<li>Employment Agreements.</li>
											<li>Service Agreements, Hire Purchase / Lease Agreements.</li>
