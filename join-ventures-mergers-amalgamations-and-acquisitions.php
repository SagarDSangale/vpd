						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="at-innerbannercontent">
								<ol class="at-breadcrumb">
									...
									<li class="at-active"><span>Join Ventures Mergers Amalgamations And Acquisitions</span></li>
								</ol>
							</div>
						</div>
					</div>
									...
									<div class="at-widget at-widgetlinking">
										<div class="at-widgetcontent">
											<ul>
												...
												<li class="at-active"><a href="join-ventures-mergers-amalgamations-and-acquisitions">Join Ventures Mergers Amalgamations And Acquisitions</a></li>
							...
							<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 pull-left">
								...
								<section class="at-servicedetailsection">
									<div class="at-sectiontitleborder">
										<h2>JOINT VENTURES, MERGERS, AMALGAMATIONS AND ACQUISITIONS</h2>
									</div>
									<div class="at-description">
									
										<p>Consolidation of business and inorganic growth through Merger and Acquisitions (M&A) is now a regular activity in the corporate sector.<h4>Our services in this area include:</h4></p>
										
										<ul class="at-liststyle at-liststylearrowright">
											<li>Evaluating the feasibility of the transaction.</li>
											<li>Legal Due Diligence.</li>
											<li>Advising on the scheme of amalgamation.</li>
											<li>Structuring of the transaction which includes nature of the JV Company, jurisdiction, drafting the terms of the JV etc.</li>
											<li>Assisting the client in negotiation of the deal.</li>
											<li>Advising and assisting to comply with the applicable laws and regulations.</li>
											<li>Advising and Undertaking Compliances of corporate   events like Merger, Demerger, Takeover, Slump Sale or     Business Transfer.</li>
										</ul>
