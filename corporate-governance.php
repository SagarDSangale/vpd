				...
				<div class="row">
				 <?php include 'logo.php'; ?>  
					<div class="at-navigationarea">
                      ...
                      <li class="current-menu-item"><a href="corporate-governance">Corporate Governance</a></li>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="at-innerbannercontent">
								<ol class="at-breadcrumb">
									...
									<li class="at-active"><span>Corporate Governance</span></li>
								</ol>
							</div>
						</div>
					</div>
									...
									<div class="at-widget at-widgetlinking">
										<div class="at-widgetcontent">
											<ul>
												...
												<li class="at-active"><a href="corporate-governance">Corporate Governance</a></li>
												...
												<li><a href="advisory-on-capital-raising">Advisory On Capital Raising</a></li>
							...
							<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 pull-left">
								...
								<section class="at-servicedetailsection">
									...
									<div class="at-description">
										...
										<p>A good corporate governance system aims at assisting the management of the Company in maintaining efficient conduct of business, in meeting various obligations towards the stakeholders and ensuring that they maintain transparency, accountability and integrity all throughout.</p>
										<p>VPD & Associates strongly believes that good corporate governance practice is the key to the growth and long term sustainability of any organization. Our service offerings under this segment include:</p>
										<ul class="at-liststyle at-liststylearrowright">
											<li>Advising and implementing Corporate Governance Standards set by Ministry of Corporate Affairs, Government of India and Listing Agreement with the Stock Exchanges.</li>
											<li>Facilitating and bringing Independent Directors on the Board of Directors as well as training them on their rights, duties and responsibilities on the Board of Companies.</li>
											<li>Advising and implementing Secretarial Standards set by Institute of Company Secretaries of India (ICSI)</li>
